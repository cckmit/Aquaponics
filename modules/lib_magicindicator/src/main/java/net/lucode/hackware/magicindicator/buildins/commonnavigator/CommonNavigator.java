...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init() {
        ...
        mTitleContainer.setPadding(mLeftPadding, mTopPadding, mRightPadding, mBottomPadding);
    ...
    public void setIndicatorColor(int count,int indicatorColor) {
        for(int i = 0;i < count;i++){
            SpecialPagerTitleView titleView = (SpecialPagerTitleView) getPagerTitleView(i);
            titleView.setNormalColor(indicatorColor);
        }
        invalidate();
    }
