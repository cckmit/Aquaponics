...
public class ClassifyPagerIndicator extends View implements IPagerIndicator {
    ...
    public ClassifyPagerIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mVerticalPadding = UIUtil.dip2px(context, 5);
