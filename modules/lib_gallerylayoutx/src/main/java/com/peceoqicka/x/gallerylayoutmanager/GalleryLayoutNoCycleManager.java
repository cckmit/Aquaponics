 ...
 * @author peceoqicka
 */
public class GalleryLayoutNoCycleManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public GalleryLayoutNoCycleManager(SnapHelper snapHelper, boolean forceToScrollToRight, int extraMargin, @BasePosition int basePosition, @TransformPosition int transformPosition, float[] centerScale, int[] customizedTransformPosition) {
...
//            consumed = absDx;
    ...
    public static class Builder {
        ...
        /**
         * 设置自定义变形范围需同时设置{@link Builder#transformPosition}为{@link GalleryLayoutNoCycleManager#POSITION_CUSTOMIZED}
        ...
        public GalleryLayoutNoCycleManager build() {
            GalleryLayoutNoCycleManager layoutManager = new GalleryLayoutNoCycleManager(snapHelper, forceToScrollToRight, extraMargin, basePosition, transformPosition, centerScale, customizedTransformPosition);
    ...
    private static class GallerySmoothScroller extends LinearSmoothScroller {
        ...
        public int calculateDxToMakeVisible(View view, int snapPreference) {
            ...
            if (layoutManager == null || !layoutManager.canScrollHorizontally() || !(layoutManager instanceof GalleryLayoutNoCycleManager)) {
                return 0;
            }
            //System.out.println("calculateDxToMakeVisible -> snapPreference : " + snapPreference);
            GalleryLayoutNoCycleManager layout = (GalleryLayoutNoCycleManager) layoutManager;
            ...
            final boolean shouldOffsetToCenter = layout.getBasePosition() == GalleryLayoutNoCycleManager.BASE_POSITION_CENTER;
    ...
    private static class GallerySnapHelper extends SnapHelper {
        private GalleryLayoutNoCycleManager mLayout;

        void attachToLayoutManager(GalleryLayoutNoCycleManager layoutManager) {
