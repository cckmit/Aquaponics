...
public class GalleryLayoutCycleManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public GalleryLayoutCycleManager(SnapHelper snapHelper, boolean forceToScrollToRight, int extraMargin, @BasePosition int basePosition, @TransformPosition int transformPosition, float[] centerScale, int[] customizedTransformPosition) {
    ...
    public static class Builder {
        ...
        public Builder setDefaultSnapHelper() {
            this.snapHelper = new GalleryLayoutCycleManager.GallerySnapHelper();
            return this;
        }
        ...
        /**
         * 设置自定义变形范围需同时设置{@link Builder#transformPosition}为{@link GalleryLayoutCycleManager#POSITION_CUSTOMIZED}
        ...
        public GalleryLayoutCycleManager build() {
            GalleryLayoutCycleManager layoutManager = new GalleryLayoutCycleManager(snapHelper, forceToScrollToRight, extraMargin, basePosition, transformPosition, centerScale, customizedTransformPosition);
    ...
    private static class GallerySmoothScroller extends LinearSmoothScroller {
        ...
        public int calculateDxToMakeVisible(View view, int snapPreference) {
            ...
            GalleryLayoutCycleManager layout = (GalleryLayoutCycleManager) layoutManager;
            ...
            final boolean shouldOffsetToCenter = layout.getBasePosition() == GalleryLayoutCycleManager.BASE_POSITION_CENTER;
    ...
    private static class GallerySnapHelper extends SnapHelper {
        private GalleryLayoutCycleManager mLayout;

        void attachToLayoutManager(GalleryLayoutCycleManager layoutManager) {
