...
import com.zhangteng.imagepicker.activitys.CameraViewActivity;
...
public class ImagePickerOpen {
    ...
    private void openNoPermission(FragmentActivity mActivity) {
        if (imagePickerConfig.getImagePickerType() == ImagePickerEnum.PHOTO_PICKER) {
            ...
            openCameraViewActivity(mActivity, Constant.CAMERA_RESULT_CODE);
        } else {
            if (mActivity != null) {
    ...
    private void openNoPermission(FragmentActivity mActivity, int requestCode) {
        if (imagePickerConfig.getImagePickerType() == ImagePickerEnum.PHOTO_PICKER) {
            ...
            openCameraViewActivity(mActivity, requestCode);
        } else {
            if (mActivity != null) {
                if (cameraDialogFragment == null) {
    ...
    private void openCameraViewActivity(Activity activity, int requestCode){
        ...
        Intent intent = new Intent(activity, CameraViewActivity.class);
