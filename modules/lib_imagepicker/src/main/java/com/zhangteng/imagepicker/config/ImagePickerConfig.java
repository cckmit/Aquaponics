...
public class ImagePickerConfig {
    ...
    public static class Builder implements Serializable {
        ...
        @ColorRes
        private int pickerThemeColorRes = R.color.image_picker_white;
        @ColorRes
        private int cropThemeColorRes = R.color.image_picker_white;
        @ColorRes
        private int pickerTitleColorRes = R.color.image_picker_text_black;
        @ColorRes
        private int cropTitleColorRes = R.color.image_picker_text_black;
        @DrawableRes
        private int pickerBackRes = R.mipmap.image_picker_back_black;
        @DrawableRes
        private int pickerFolderRes = R.mipmap.image_picker_folder_black;
